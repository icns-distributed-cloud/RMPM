...
def getBlockIndex(item, accumulate_len):
    """
    주어진 인덱스 항목을 기준으로 해당 항목이 어떤 모듈에서 선택되어야 하는지 제공합니다.
    :param item: item 또는 index 레이어의 인덱스, 0부터 시작합니다.
    :param accumulate_len: 각 부분의 누적 합을 나타내는 목록
    :return: 해당 모듈의 인덱스 part_index입니다. part_index = 0은 features를 나타냅니다. 이와 같이 part_index = 1은 inception3을 나타냅니다.
    """
